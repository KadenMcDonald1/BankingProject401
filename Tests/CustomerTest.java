...
public class CustomerTest {
	...
	public void freezeTest() {
		...
		cust1.addAccount(accountType.CHECKINGS, 3000);
	...
	public void thawTest() {
		...
		cust2.addAccount(accountType.CHECKINGS, 3000);
	...
	public void removeAccountTest() {
		...
		cust8.addAccount(accountType.CHECKINGS, 3000);
	...
	public void transferBetweenOwnedAccountsTest() {
		...
		cust9.addAccount(accountType.CHECKINGS, 3000);
		cust9.addAccount(accountType.SAVINGS, 4000);
	...
	public void transferBetweenOutsideAccountsTest() {
		...
		cust10.addAccount(accountType.CHECKINGS, 3000);
