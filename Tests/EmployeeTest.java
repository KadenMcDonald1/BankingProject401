...
public class EmployeeTest {
	...
	public void thawCurCustAccTest() {
		...
		cust5.addAccount(accountType.CHECKINGS, 3000);
	...
	public void removeAccountTest() {
		...
		cust6.addAccount(accountType.CHECKINGS, 3000);
	...
	public void transferBetweenOwnedAccountsTest() {
		...
		cust7.addAccount(accountType.CHECKINGS, 3000);
		cust7.addAccount(accountType.SAVINGS, 4000);
